...
class Template
{
 ...
 /**
  * Activate comments in templates with {* some text *}.
  *
  * @var       boolean
  * @access    private
  * @see       finish
  */
  var $star_comments= true;
  ...
  */
  ...
  return $this->finish($this->get_var($target));
  }
